...
public class BroadcastStreamDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		// 自定义数据流（单例）
		DataStream<String> dataStream = environment.addSource(new RichParallelSourceFunction<String>() {
		...
		dataStream.connect(broadcastStream).process(new BroadcastProcessFunction<String, String, String>() {
			...
			public void open(Configuration parameters) throws Exception {
				...
				Thread.sleep(i);
				System.out.println("初始时："+keywords+" 沉睡了："+(System.currentTimeMillis()-tiem1));
				keywords = "java";
...
//					System.out.println("拦截消息:" + value + ", 原因:包含拦截关键字：" + keywords);
